...
public class EhCacheProvider implements ICacheProvider {
	...
	public void start() throws CacheException {
		...
		String confPath= "ehcache.xml";
		try {
			manager = new CacheManager(new FileInputStream(confPath));
		} catch (net.sf.ehcache.CacheException | FileNotFoundException e) {
			log.error("Unabled to create EhCache CacheManager by file path :" + confPath, e);
		}
